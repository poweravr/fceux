...
inline int write_double_le(double b, EMUFILE*is)
{
  uint64 temp = double_to_u64(b);
...
inline int read16le(int16 *Bufo, EMUFILE*is)
{
  return read16le((uint16*)Bufo,is);
}
int read32le(uint32 *Bufo, EMUFILE*is);
inline int read32le(int32 *Bufo, EMUFILE*is)
{
  return read32le((uint32*)Bufo,is);
}
...
int readle(T *Bufo, EMUFILE*is)
{
  ...
  {
    case 1:
      return read8le((uint8*)Bufo,is);
    case 2:
      return read16le((uint16*)Bufo,is);
    case 4:
      return read32le((uint32*)Bufo,is);
    case 8:
      return read64le((uint64*)Bufo,is);
    default:
      return 0;
  }
}
...
int writele(T *Bufo, EMUFILE*os)
{
  ...
  {
    case 1:
      return write8le(*(uint8*)Bufo,os);
    case 2:
      return write16le(*(uint16*)Bufo,os);
    case 4:
      return write32le(*(uint32*)Bufo,os);
    case 8:
      return write64le(*(uint64*)Bufo,os);
    default:
      return 0;
  }
}
