...
void FCEUSND_Reset(void)
{
  ...
  if(movieSyncHackOn)
  {
    if(resetDMCacc)
    {
      ...
      printf("Warning: These variables were not found in the save state and will keep their current value: DMCacc=%d, DMCBitCount=%d\n", DMCacc, DMCBitCount);
#endif
    }
    else
    {
...
//	printf("DMCacc=%d, DMCBitCount=%d",DMCacc,DMCBitCount);
}
