...
CORE_OBJS = \
  ...
  $(SRC)nsf.o $(SRC)palette.o $(SRC)ppu.o $(SRC)sound.o \
  $(SRC)state.o $(SRC)unif.o $(SRC)video.o $(SRC)vsuni.o \
  $(SRC)x6502.o $(SRC)netplay.o $(SRC)emufile.o
...
INPUT_OBJS = $(SRC)input/arkanoid.o $(SRC)input/bworld.o $(SRC)input/cursor.o \
  ...
  $(SRC)input/mahjong.o $(SRC)input/mouse.o $(SRC)input/oekakids.o \
  $(SRC)input/pec586kb.o $(SRC)input/powerpad.o $(SRC)input/quiz.o \
  $(SRC)input/shadow.o $(SRC)input/snesmouse.o $(SRC)input/suborkb.o \
  $(SRC)input/toprider.o $(SRC)input/zapper.o

MAPPERS_OBJS = 

UTILS_OBJS = $(SRC)utils/crc32.o $(SRC)utils/endian.o $(SRC)utils/general.o \
  $(SRC)utils/guid.o $(SRC)utils/md5.o $(SRC)utils/memory.o \
  $(SRC)utils/unzip.o $(SRC)utils/xstring.o $(SRC)utils/ioapi.o \
  $(SRC)utils/ConvertUTF.o
...
DRIVER_OBJS = $(SRC)drivers/dingux-sdl/config.o \
  $(SRC)drivers/dingux-sdl/input.o \
  $(SRC)drivers/dingux-sdl/dingoo.o \
  $(SRC)drivers/dingux-sdl/dingoo-joystick.o \
  $(SRC)drivers/dingux-sdl/dingoo-throttle.o \
  $(SRC)drivers/dingux-sdl/dingoo-sound.o \
  $(SRC)drivers/dingux-sdl/dingoo-video.o \
  $(SRC)drivers/dingux-sdl/dummy-netplay.o \
  $(SRC)drivers/dingux-sdl/2xSaI.o \
  $(SRC)drivers/dingux-sdl/scaler.o $(MINIMAL_OBJS) $(GUI_OBJS)

OBJS = $(CORE_OBJS) $(BOARDS_OBJS) $(INPUT_OBJS) $(MAPPERS_OBJS) \
  $(UTILS_OBJS) $(COMMON_DRIVER_OBJS) $(DRIVER_OBJS)
...
CC_OPTS     += $(F_OPTS) $(W_OPTS)
CFLAGS      += $(CC_OPTS)
CFLAGS      += -DDINGUX -DLSB_FIRST -DPSS_STYLE=1 -DFRAMESKIP -D_GNU_SOURCE=1
CXXFLAGS    += $(CFLAGS)
LDFLAGS     += $(CC_OPTS)
ifdef STATIC
